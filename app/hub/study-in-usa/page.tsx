          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://ai.eecglobal.com/usavisaprep" className="bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition">
                  Try Free AI Tools
                </a>
              ...
              <div className="mt-8 bg-gradient-to-r from-indigo-600 to-purple-700 p-6 rounded-xl text-white">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://ai.eecglobal.com/usavisaprep" className="inline-block bg-white text-indigo-600 px-6 py-2 rounded-lg font-semibold hover:bg-indigo-50 transition">
                      Start Free Practice →
                    </a>
                  </div>
                </div>
            ...
            <div className="sticky top-4 space-y-6">
              <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-6 rounded-xl text-white">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="https://ai.eecglobal.com/usavisaprep" className="flex items-center gap-2 bg-white/10 hover:bg-white/20 p-3 rounded-lg transition">
