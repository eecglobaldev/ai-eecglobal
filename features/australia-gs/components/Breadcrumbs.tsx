...
const BREADCRUMB_ITEMS: BreadcrumbItem[] = [
  ...
  {
    name: 'Australia Course Search',
    url: 'https://courses.eecglobal.com/australia',
  },
  {
        ...
        {BREADCRUMB_ITEMS.map((item, index) => (
          ...
          >
            ...
            {item.current ? (
              ...
              <a
                href={item.url}
                target={item.url.includes('ai.eecglobal.com/australiagsprep') ? '_self' : '_blank'}
                rel={item.url.includes('ai.eecglobal.com/australiagsprep') ? undefined : 'noopener noreferrer'}
