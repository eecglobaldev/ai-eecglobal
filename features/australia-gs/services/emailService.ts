...
const buildCompleteEmailBody = (userData: any, academicPlan?: any, targetCountry: string = 'Australia'): string => {
  let body = `New User Registration - ${targetCountry}-gs-prep Visa Prep\n\n`;
...
export const sendRegistrationNotificationEmailsUniversal = async (userData: any, academicPlan?: any): Promise<boolean> => {
  try {
    ...
    const adminEmails = [
      ...
      'eecprexa@gmail.com',
      'eecbaroda@gmail.com',
      'eecaustralia01@gmail.com',
      'eeccouns55@gmail.com',
      'eeccouns35@gmail.com'
    ];
    ...
    const targetCountry = String(userData.targetCountry || 'Australia').trim();
    ...
    // Build subject line
    const subject = `[${targetCountry} Visa Prep] New User Registration - ${targetCountry}-gs-prep Visa Prep`;
