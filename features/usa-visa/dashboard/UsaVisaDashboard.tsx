...
const COLLECTION_NAME = 'usa_users';
...
const UsaVisaDashboard: React.FC = () => {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
            console.log('currentUser in UsaVisaDashboard', currentUser);
            
            if (currentUser) {
                console.log('currentUser in UsaVisaDashboard is authenticated', currentUser);
