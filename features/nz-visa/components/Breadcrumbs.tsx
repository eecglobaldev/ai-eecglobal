...
const BREADCRUMB_ITEMS: BreadcrumbItem[] = [
  ...
  },
  {
    ...
    url: 'https://courses.eecglobal.com/new-zealand',
  },
  {
        ...
        {BREADCRUMB_ITEMS.map((item, index) => (
          ...
          >
            ...
            {item.current ? (
              ...
              <a
                href={item.url}
                target={item.url.includes('ai.eecglobal.com/nzvisaprep') ? '_self' : '_blank'}
                rel={item.url.includes('ai.eecglobal.com/nzvisaprep') ? undefined : 'noopener noreferrer'}
