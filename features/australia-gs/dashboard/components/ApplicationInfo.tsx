...
const ApplicationInfo: React.FC<ApplicationInfoProps> = ({ applicationData, theme = 'dark' }) => {
  ...
  const InfoCard: React.FC<{ label: string; value: any; highlight?: boolean }> = ({ label, value, highlight }) => {
    ...
    return (
      <div className="bg-white/5 p-3 rounded-xl">
        ...
        <p className={`text-sm font-medium ${highlight ? 'text-primary-white' : ''}`}>{String(value)}</p>
      </div>
    );
  };
  ...
  return (
    <div className="bg-glass-bg p-4 sm:p-6 rounded-2xl sm:rounded-3xl backdrop-blur-lg border border-glass-border">
      <h3 className="text-xl sm:text-2xl font-bold mb-6 text-primary-white">📋 Application Information</h3>
          ...
          <div>
            ...
            {expandedSections.personal && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-2">
                <InfoCard label="Full Name" value={personal.fullName} />
          ...
          <div>
            ...
            {expandedSections.course && (
              <div className="grid grid-cols-1 gap-3 pl-2">
                <InfoCard label="Institution" value={courseSelection.institution} />
                <InfoCard label="Course Name" value={courseSelection.courseName} />
          ...
          <div>
            ...
            {expandedSections.academics && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-2">
                ...
                <InfoCard label="Class 10 Grade" value={academics.class10Grade} />
                <InfoCard label="Class 12 Board" value={academics.class12Board} />
                <InfoCard label="Class 12 Grade" value={academics.class12Grade} />
          ...
          <div>
            ...
            {expandedSections.english && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pl-2">
                <InfoCard label="Test" value={englishProficiency.tests[0].test} />
                <InfoCard label="Overall" value={englishProficiency.tests[0].overall} />
        ...
        {financial && (
          <div>
            ...
            {expandedSections.financial && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-2">
                <InfoCard label="Living Sponsor" value={financial.livingSponsor} />
                  ...
                  <div className="bg-white/5 p-4 rounded-xl col-span-full">
                    ...
                    {financial.sponsors.map((sponsor: any, idx: number) => (
                      <div key={idx} className="mb-3 pb-3 border-b border-white/10 last:border-0">
                        <p className="text-sm font-semibold text-primary-white">{sponsor.name} - {sponsor.relation}</p>
