...
export const saveStudentApplication = async (
  ...
  try {
    ...
    // Helper function to remove undefined values recursively (but preserve Firestore sentinels)
    ...
    // Clean the data before saving (remove undefined values, but don't clean timestamps yet)
    ...
    // Prepare data to save with timestamps (don't clean timestamps!)
    ...
    // ========== STEP 4: Save Transcript File Metadata to Subcollection ==========
