 ...
 * 
 * @param email - User email
 * @param collection - Collection name (uk_users, nz_users, etc.)
 * @returns true if migration successful
 */
const callMigrationCloudFunction = async (
  email: string,
  collection: string = 'uk_users'
): Promise<boolean> => {
  try {
 ...
 * 
 * @param email - User email
 * @param collection - Optional collection name for migration (default: uk_users)
 * @returns Firebase User or null
 */
