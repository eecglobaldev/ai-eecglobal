...
// Fetches user data from Firestore and sends to admins, branch counselors, and country admins
export const sendCareerInsightNotificationEmails = async (userEmail: string, targetCountry?: string): Promise<boolean> => {
  try {
    ...
    const country = targetCountry || userData.lastTargetCountry;
    if (country) {
