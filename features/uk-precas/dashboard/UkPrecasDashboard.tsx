...
const COLLECTION_NAME = 'uk_users';
      ...
      <div className="flex-1 flex flex-col ml-2 sm:ml-4 lg:ml-8 gap-4 sm:gap-6">
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4 sm:gap-6 overflow-hidden">
          <div className="flex-1 flex flex-col gap-4 sm:gap-6 overflow-y-auto pr-2 pb-4">
            ...
            <AcademicPlanInfo academicPlanData={profile.academicPlanData} theme={theme} />
...
const UkPrecasDashboard: React.FC = () => {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
            console.log('currentUser in UkPrecasDashboard', currentUser);
            
            if (currentUser) {
                console.log('currentUser in UkPrecasDashboard is authenticated', currentUser);
...
export default UkPrecasDashboard;
