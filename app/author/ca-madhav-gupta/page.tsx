        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-start">
            <div className="lg:col-span-1">
              <div className="relative w-64 h-64 mx-auto lg:mx-0 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden">
                <Image
