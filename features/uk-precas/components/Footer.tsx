...
"datePosted": "2026-01-01",
  ...
  const aiToolsSiloSchema = {
    ...
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "item": { "@type": "SoftwareApplication", "name": "UK Pre-CAS & Airport Interview Prep 2026", "description": "AI-powered UK credibility interview preparation for September 2026 & January 2027 intakes. Personalized questions, audio recording, transcription, real-time feedback for Tier 4 student visa success. 25,000+ mock interviews completed.", "url": "/ukprecas", "applicationCategory": "EducationalApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR", "priceValidUntil": "2027-12-31" } } },
      { "@type": "ListItem", "position": 2, "item": { "@type": "SoftwareApplication", "name": "USA F-1 Student Visa Interview Prep", "description": "AI tool for F-1 visa interview practice with consular interview simulation", "url": "/usavisaprep", "applicationCategory": "EducationalApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" } } },
      { "@type": "ListItem", "position": 3, "item": { "@type": "SoftwareApplication", "name": "Australia GS Visa Interview Prep", "description": "Genuine Student (GS) requirement preparation for Australian student visa", "url": "/australiagsprep", "applicationCategory": "EducationalApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" } } },
      ...
      { "@type": "ListItem", "position": 5, "item": { "@type": "SoftwareApplication", "name": "New Zealand Visa Interview Prep", "description": "NZ student visa interview practice tool", "url": "/nzvisaprep", "applicationCategory": "EducationalApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" } } },
      { "@type": "ListItem", "position": 6, "item": { "@type": "SoftwareApplication", "name": "ALL COUNTRY Career Counselor", "description": "AI career counselor providing course-based career prospects, salary data, hiring companies across all countries", "url": "/careercounselor", "applicationCategory": "EducationalApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" } } },
      { "@type": "ListItem", "position": 7, "item": { "@type": "SoftwareApplication", "name": "EEC Visa & Travel Agent", "description": "AI agent for tourist visa, student visa information, and flight bookings for 40+ countries", "url": "/travelagent", "applicationCategory": "TravelApplication", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" } } },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="space-y-1.5 text-xs">
              ...
              <li><a href="/ukprecas" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">🇬🇧 UK Pre-CAS 2026</a></li>
              <li><a href="/usavisaprep" target="_blank" rel="noopener noreferrer" className="text-slate-700 dark:text-slate-300 hover:text-blue-600 transition-colors">🇺🇸 USA F-1 Visa Prep</a></li>
              <li><a href="/australiagsprep" target="_blank" rel="noopener noreferrer" className="text-slate-700 dark:text-slate-300 hover:text-blue-600 transition-colors">🇦🇺 Australia GS Prep</a></li>
              ...
              <li><a href="/nzvisaprep" target="_blank" rel="noopener noreferrer" className="text-slate-700 dark:text-slate-300 hover:text-blue-600 transition-colors">🇳🇿 New Zealand Prep</a></li>
